    ...
    public partial class mesajlar : System.Web.UI.Page
    {
        ...
        protected void grdMesajlar_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (grdMesajlar.SelectedIndex > -1) // seçili sayfa var
            {
                ...
                SqlDataAdapter dap = new SqlDataAdapter("Select * from GelenMesajlar where mesaj_id=@mesaj_id and silindi=0", baglanti);
                ...
                if (dtIcerik.Rows.Count > 0) //kayıt bulundu
                {
                    ...
                    lblIPAdresi.Text = dtIcerik.Rows[0]["ekleyen_ip"].ToString();
        ...
        protected void btnKaydet_Click(object sender, EventArgs e)
        {
            ...
            {
                lblMesaj.Text = "Mesaj güncellendi.";
            }
        }
